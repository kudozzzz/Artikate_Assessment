...
- ANSWERS.md → written responses and analysis  
...
- Precision@3: 1.00 (10/10 on test set)

---

## Section 3 — Ticket Classifier Under Latency Constraints

Implemented a lightweight CPU-friendly classifier for support ticket routing.
...
- selected for fast CPU inference, simple deployment, and strong baseline accuracy
...
- train / test workflow
- confusion matrix
- latency assertion test under 500ms
